  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <a href="https://createshape3d.com/wp-admin/edit.php?post_type=product" target="_blank" rel="noopener noreferrer" className="bg-white rounded-xl border border-neutral-200 p-5 hover:shadow-md transition-shadow flex items-center gap-4">
        ...
        <a href="https://createshape3d.com/wp-admin/edit-tags.php?taxonomy=product_cat&post_type=product" target="_blank" rel="noopener noreferrer" className="bg-white rounded-xl border border-neutral-200 p-5 hover:shadow-md transition-shadow flex items-center gap-4">
        ...
        <a href="https://createshape3d.com/wp-admin/edit.php?post_type=page" target="_blank" rel="noopener noreferrer" className="bg-white rounded-xl border border-neutral-200 p-5 hover:shadow-md transition-shadow flex items-center gap-4">
